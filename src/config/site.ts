...
export const portfolio: SisterSite[] = [
  { domain: "adversarialml.dev", url: "https://adversarialml.dev", title: "Adversarial ML", tagline: "Intelligence, summarized." },
...
export const siteConfig: SiteConfig = {
  domain: "aisecdigest.com",
  url: "https://aisecdigest.com",
  title: "AI Sec Digest",
  tagline: "Curated AI security news, daily.",
  description:
    "Daily digest of AI security news. Breach disclosures, CVE coverage, regulatory action, and primary-source-only summaries for security teams who can't read every advisory and don't want to.",
  byline: "AI Sec Digest Editorial",
  language: "en",
  locale: "en_US",
  themeColor: "#0a0a0a",
  brand: { accentHue: 45, cluster: "news" },
  social: { rss: "/rss.xml" },
  email: {
    contact: "hello@aisecdigest.com",
    abuse: "abuse@aisecdigest.com",
    editor: "editor@aisecdigest.com",
  },
  ...
  sister: portfolio.filter((s) => s.domain !== "aisecdigest.com"),
  analytics: {},
};
